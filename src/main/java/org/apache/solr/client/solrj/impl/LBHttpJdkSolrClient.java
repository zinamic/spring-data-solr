...
/**
 * LBHttpJdkSolrClient or "LoadBalanced LBHttpJdkSolrClient" is a load balancing wrapper around {@link
 * HttpJdkSolrClient}. This is useful when you have multiple Solr servers and the requests need to be
 ...
 *
 * <pre>
 * SolrClient lbHttpJdkSolrClient = new LBHttpJdkSolrClient(httpJdkSolrClient, "http://host1:8080/solr/", "http://host2:8080/solr", "http://host2:8080/solr");
 * </pre>
 *
 * </blockquote>
 *
 ...
 * LBHttpJdkSolrClient.Builder#setAliveCheckInterval(int)} , the default is set to one minute.
 *
 ...
 * @since solr 8.0
 */
public class LBHttpJdkSolrClient extends LBSolrClient {
  private final HttpJdkSolrClient solrClient;

  /**
   * @deprecated Use {@link LBHttpJdkSolrClient.Builder} instead
   */
  @Deprecated
  public LBHttpJdkSolrClient(HttpJdkSolrClient solrClient, String... baseSolrUrls) {
    super(Arrays.asList(baseSolrUrls));
    this.solrClient = solrClient;
  }

  private LBHttpJdkSolrClient(Builder builder) {
    super(Arrays.asList(builder.baseSolrUrls));
    this.solrClient = builder.httpJdkSolrClient;
   ...
   * @deprecated Pass in a configured {@link HttpJdkSolrClient} instead
   */
  @Deprecated
  @Override
  ...
  public RequestWriter getRequestWriter() {
    return solrClient.requestWriter;
  }
  ...
  private CompletableFuture<NamedList<Object>> doAsyncRequest(
    ...
    CompletableFuture<NamedList<Object>> future =
        ((HttpJdkSolrClient) getClient(endpoint)).requestAsync(req.getRequest());
    future.whenComplete(
        (result, throwable) -> {
  ...
  public static class Builder {
    ...
    private final HttpJdkSolrClient httpJdkSolrClient;
     ...
     *
     * <pre>
     *   SolrClient client = new LBHttpJdkSolrClient.Builder(client, "http://my-solr-server:8983/solr/core1").build();
     ...
     *
     * <pre>
     *   SolrClient client = new LBHttpJdkSolrClient.Builder(client, "http://my-solr-server:8983/solr").build();
     ...
     *
     * @deprecated use {@link #Builder(HttpJdkSolrClient, Endpoint...)} instead
     */
    @Deprecated
    public Builder(HttpJdkSolrClient httpJdkClient, String... baseSolrUrls) {
      this.httpJdkSolrClient = httpJdkClient;
     ...
     *
     * <pre>
     *   SolrClient client = new LBHttpJdkSolrClient.Builder(
     ...
     */
    public LBHttpJdkSolrClient.Builder setAliveCheckInterval(int aliveCheckInterval, TimeUnit unit) {
     ...
     */
    public LBHttpJdkSolrClient.Builder withDefaultCollection(String defaultCoreOrCollection) {
