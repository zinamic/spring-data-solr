...
/**
 * SolrJ client class to communicate with SolrCloud using HttpJdkSolrClient. Instances of this class
 * communicate with Zookeeper to discover Solr endpoints for SolrCloud collections, and then use the
 * {@link LBHttpJdkSolrClient} to issue requests.
 *
 * @since solr 8.0
 */
@SuppressWarnings("serial")
public class CloudHttpJdkSolrClient extends CloudSolrClient {

  private final ClusterStateProvider stateProvider;
  private final LBHttpJdkSolrClient lbClient;
  private final HttpJdkSolrClient myClient;
   ...
   * leaders by default.
   *
   * @param builder a {@link HttpJdkSolrClient.Builder} with the options used to create the client.
   */
  protected CloudHttpJdkSolrClient(Builder builder) {
    super(builder.shardLeadersOnly, builder.parallelUpdates, builder.directUpdatesToLeadersOnly);
    this.clientIsInternal = builder.httpClient == null;
    this.myClient = createOrGetHttpClientFromBuilder(builder);
    this.stateProvider =
        builder.zkHosts.isEmpty()
            ? createHttpJdkClusterStateProvider(builder.solrUrls, myClient)
    ...
    this.lbClient = new LBHttpJdkSolrClient.Builder(myClient, new String[0]).build();
  }

  private HttpJdkSolrClient createOrGetHttpClientFromBuilder(Builder builder) {
  ...
  private ClusterStateProvider createHttpJdkClusterStateProvider(
      List<String> solrUrls, HttpJdkSolrClient httpClient) {
    try {
      return new HttpJdkClusterStateProvider(solrUrls, httpClient);
    } catch (Exception e) {
      closeMyClientIfNeeded();
  ...
  @Override
  public LBHttpJdkSolrClient getLbClient() {
    return lbClient;
  }
  ...
  public HttpJdkSolrClient getHttpClient() {
    return myClient;
  }
  ...
  /** Constructs {@link CloudHttpJdkSolrClient} instances from provided configuration. */
  public static class Builder {
    protected Collection<String> zkHosts = new ArrayList<>();
    protected List<String> solrUrls = new ArrayList<>();
    protected String zkChroot;
    protected HttpJdkSolrClient httpClient;
    protected boolean shardLeadersOnly = true;
    protected boolean directUpdatesToLeadersOnly = false;
    protected boolean parallelUpdates = true;
    protected ClusterStateProvider stateProvider;
    protected HttpJdkSolrClient.Builder internalClientBuilder;
    ...
    /**
     * Provide a series of Solr URLs to be used when configuring {@link CloudHttpJdkSolrClient}
     ...
     *   final SolrClient client = new CloudHttpJdkSolrClient.Builder(solrBaseUrls).build();
     * </pre>
     */
    ...
    /**
     * Provide a series of ZK hosts which will be used when configuring {@link CloudHttpJdkSolrClient}
     * instances.
     *
     ...
     *   final SolrClient client = new CloudHttpJdkSolrClient.Builder(zkServers, Optional.empty()).build();
     * </pre>
     *
     ...
     *    final List&lt;String&gt; zkServers = new ArrayList&lt;String&gt;();
     *    zkServers.add("zookeeper1:2181"); zkServers.add("zookeeper2:2181"); zkServers.add("zookeeper3:2181");
     *    final SolrClient client = new CloudHttpJdkSolrClient.Builder(zkServers, Optional.of("/solr")).build();
     *  </pre>
     *
    ...
    /**
     * Tells {@link CloudHttpJdkSolrClient.Builder} that created clients should send direct updates to
     * shard leaders only.
     *
    ...
    /**
     * Tells {@link CloudHttpJdkSolrClient.Builder} that created clients can send updates to any shard
    ...
    /**
     * Tells {@link CloudHttpJdkSolrClient.Builder} whether created clients should send shard updates
     * serially or in parallel
     *
     * <p>When an {@link UpdateRequest} affects multiple shards, {@link CloudHttpJdkSolrClient} splits
     ...
     * @return this
     */
    public Builder withHttpClient(HttpJdkSolrClient httpClient) {
    ...
    /**
     * If provided, the CloudHttpJdkSolrClient will build it's internal HttpJdkSolrClient using this
     ...
     * @return this
     */
    public Builder withInternalClientBuilder(HttpJdkSolrClient.Builder internalClientBuilder) {
    ...
    /** Create a {@link CloudHttpJdkSolrClient} based on the provided configuration. */
    public CloudHttpJdkSolrClient build() {
      ...
      return new CloudHttpJdkSolrClient(this);
    }
  }
}
